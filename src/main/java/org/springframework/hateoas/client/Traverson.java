...
public class Traverson {
	...
	public class TraversalBuilder {
		...
		private String traverseToFinalUrl() {
			...
			return getAndFindLinkWithRel(baseUri.toString(), rels.iterator(), this.headers).uriAsString;
		}

		private LinkWithHeader traverseToExpandedFinalUrl() {

			return getAndFindLinkWithRel(baseUri.toString(), rels.iterator(), this.headers);
		}
