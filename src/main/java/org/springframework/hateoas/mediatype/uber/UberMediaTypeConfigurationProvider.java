 ...
 */
class UberMediaTypeConfigurationProvider implements MediaTypeConfigurationProvider, ProvidedMediatype {
	...
	public boolean supportsAny(Collection<MediaType> providedMediaTypes) {
		return providedMediaTypes.contains(MediaTypes.UBER_JSON);
	}
}
