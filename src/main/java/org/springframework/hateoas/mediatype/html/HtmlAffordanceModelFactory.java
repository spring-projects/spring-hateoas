 ...
 */
public class HtmlAffordanceModelFactory implements AffordanceModelFactory {
	...
	public AffordanceModel getAffordanceModel(ConfiguredAffordance configured) {
		return new AffordanceModel(configured.getNameOrDefault(), configured.getTarget(), configured.getMethod(),
