...
//		// }
//
//		List<AnnotatedParam<RequestParam>> requestParams = MethodAnnotationUtils.getParamsWithAnnotation(
//				method, RequestParam.class);
//
...
//		for (AnnotatedParam<RequestParam> annotatedParam : requestParams) {
//			String formH1 = "Form " + formName;
//			sb.append(String.format(FORM_START, action, formName, requestMethod.toString(), formH1));
//
//			RequestParam annotation = annotatedParam.paramAnnotation;
//			String requestParamName = annotation.value();
//			Class<?> requestParamArg = annotatedParam.paramType;
