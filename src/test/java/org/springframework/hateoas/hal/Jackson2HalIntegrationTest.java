...
public class Jackson2HalIntegrationTest extends AbstractJackson2MarshallingIntegrationTest {
	...
	static final String ANNOTATED_PAGED_RESOURCES = "{\"page\":{\"totalPages\":2,\"pageSize\":2,\"totalItems\":4,\"pageNumber\":0},\"_links\":{\"next\":{\"href\":\"foo\"},\"prev\":{\"href\":\"bar\"}},\"_embedded\":{\"pojos\":[{\"text\":\"test1\",\"number\":1,\"_links\":{\"self\":{\"href\":\"localhost\"}}},{\"text\":\"test2\",\"number\":2,\"_links\":{\"self\":{\"href\":\"localhost\"}}}]}}";
	// TODO: the value should be updated accroding to required logic
