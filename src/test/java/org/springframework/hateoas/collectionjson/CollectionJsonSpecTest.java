...
public class CollectionJsonSpecTest {
	...
	public void specPart1() throws IOException {
		...
		assertThat(resource.getRequiredLink(IanaLinkRelation.SELF.value())).isEqualTo(new Link("https://example.org/friends/"));
	}
	...
	public void specPart2() throws IOException {
		...
		assertThat(resources.getRequiredLink(IanaLinkRelation.SELF.value())).isEqualTo(new Link("https://example.org/friends/"));
		...
		assertThat(friends.get(0).getRequiredLink(IanaLinkRelation.SELF.value())).isEqualTo(new Link("https://example.org/friends/jdoe"));
		...
		assertThat(friends.get(1).getRequiredLink(IanaLinkRelation.SELF.value())).isEqualTo(new Link("https://example.org/friends/msmith"));
		...
		assertThat(friends.get(2).getRequiredLink(IanaLinkRelation.SELF.value())).isEqualTo(new Link("https://example.org/friends/rwilliams"));
	...
	public void specPart3() throws IOException {
		...
		assertThat(resource.getRequiredLink(IanaLinkRelation.SELF.value())).isEqualTo(new Link("https://example.org/friends/jdoe"));
